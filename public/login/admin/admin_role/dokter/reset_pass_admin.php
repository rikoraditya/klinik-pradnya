...
if (isset($_POST['ubah'])) {
    ...
    // Query update
    $stmt = $conn->prepare("UPDATE admin SET username = ?, password = ?, role = ? WHERE username = ?");
    $stmt->bind_param("ssss", $username_baru, $password_baru, $role_baru, $login_user);
    ...
    if ($stmt->execute()) {
        ...
        echo "<script>alert('Username, Password, dan Role berhasil diubah!'); window.location='dashboard.php';</script>";
    } else {
    ...
    <div class="flex h-screen">
            ...
            <nav class="">
                ...
                <div class="mb-2">
                    ...
                    <div id="rmMenu"
                        ...
                        <a href="rm/tambah.php" class="block cursor-pointer hover:text-gray-300">Tambah
                            Rekam
                            Medis</a>
                        <a href="rm/manage.php" class="block cursor-pointer hover:text-gray-300">Manage
                            Rekam
                            Medis</a>
                    </div>
        ...
        <div class="flex-1 flex flex-col">
            ...
            <main class="flex-1 p-8 ml-64 transition-all duration-300 font-poppins" id="mainContent">
                <h1 class="text-xl font-bold font-poppins">Dokter</h1>
