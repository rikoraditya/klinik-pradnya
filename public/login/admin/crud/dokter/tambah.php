  ...
  <div class="flex h-screen">
    ...
    <div class="flex-1 flex flex-col">
      ...
      <main class="flex-1 p-8 ml-64 transition-all duration-300 font-poppins" id="mainContent">
        ...
        <p class="text-gray-600">Tambah Dokter</p>

        <div class="max-w-full mt-4 mx-auto bg-white p-6 rounded-lg shadow-md">
          <h2 class="text-xl font-bold mb-4">Form Data Dokter</h2>
          <form action="../../../../php/proses_dokter.php" method="POST" enctype="multipart/form-data">
